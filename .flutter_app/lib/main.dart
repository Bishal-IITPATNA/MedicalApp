...
void main() {
  // Some headless / preview browsers report empty or non-standard
  // navigator.language strings which crash the `intl` package on startup
  // ("Invalid argument(s): Incorrect locale information provided").
  // Force a sane default locale for the whole app.
