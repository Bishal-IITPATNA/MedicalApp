...
class SelectMedicalStoreScreen extends StatefulWidget {
  ...
  final String? prescriptionDataUrl;
...
class _SelectMedicalStoreScreenState extends State<SelectMedicalStoreScreen> {
  ...
  Future<void> _placeOrder() async {
    ...
    try {
      ...
      if (widget.prescriptionDataUrl != null) {
        payload['prescription_image'] = widget.prescriptionDataUrl;
        payload['prescription_filename'] = widget.prescriptionFilename;
      }
      final response = await _apiService.post(
