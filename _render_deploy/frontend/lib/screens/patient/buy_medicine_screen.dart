      ...
      result = await Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => SelectMedicalStoreScreen(
            ...
            prescriptionDataUrl: _prescriptionDataUrl,
  ...
  Future<bool> _placeHomeDeliveryOrder(List<Map<String, dynamic>> items) async {
    try {
      ...
      if (_prescriptionDataUrl != null) {
        payload['prescription_image'] = _prescriptionDataUrl;
        payload['prescription_filename'] = _prescriptionFilename;
      }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                PrescriptionPicker(
                  key: const ValueKey('rx-medicine-picker'),
