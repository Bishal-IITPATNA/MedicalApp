...
void main() {
  // Some headless / preview browsers report empty or non-canonical
  // navigator.language, which crashes the `intl` package on startup
  // ("Invalid argument(s): Incorrect locale information provided").
  // Force a sane default for the whole app.
