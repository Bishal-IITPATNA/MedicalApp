        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'We have sent a 6-digit OTP to your ${_usePhone ? 'phone' : 'email'}',
                style: const TextStyle(fontSize: 16, color: Colors.grey),
                textAlign: TextAlign.center,
              ),
              const SizedBox(height: 8),
              Text(
                _usePhone ? 'Phone ending in ${widget.resetData['email'] ?? ''}' : widget.resetData['email'] ?? '',
              ...
              const SizedBox(height: 24),
              if (widget.resetData['phone_available'] == true)
                Row(
