...
class _NurseDashboardState extends State<NurseDashboard> {
  ...
  Future<void> _loadUserData() async {
    try {
      ...
      if (response['success'] && mounted) {
        ...
        if (profileData != null) {
          setState(() {
            _nurseName = profileData['name'] ?? 'Nurse';
          });
        }
      }
    } catch (e) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(_selectedIndex == 0 ? 'Nurse Dashboard' : 'Appointments'),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Nurse ${_nurseName.isNotEmpty ? _nurseName : 'Professional'}',
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize: 28,
                      fontWeight: FontWeight.bold,
          ...
          FutureBuilder(
            future: _apiService.get('/api/nurse/appointments'),
            builder: (context, snapshot) {
  ...
  Widget _buildProfileTab() {
    return const NurseProfileScreen();
  }
